...
const Mar = () => {
  ...
  return (
    <div className="card">
      ...
      <TableHeader title="Medication Administration Records" className="py-3 pt-5 fs-3 card-header"/>
        ...
        <div className="gap-3 d-flex flex-wrap">
          ...
          >
            <span className="d-flex align-items-center">
              ...
              <span className="d-none d-sm-inline-block">Active MAR</span>
            </span>
          </button>
          <button
          ...
          >
            <span className="d-flex align-items-center">
              ...
              <span className="d-none d-sm-inline-block">InActive MAR</span>
            </span>
          </button>
        </div>
        <div className="mt-5">
