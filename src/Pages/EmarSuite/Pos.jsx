    ...
    <div className="card">
     ...
     <div className="mb-3 col-md-6">
        ...
        >
          ...
          <option value="Abdirahman Mohamed">Abdirahman Mohamed (Abdirahman@gmail.com)</option>
        </select>
      </div>
      ...
      <div className="mb-3 col-md-6">
        <label htmlFor="medicareNumber" className="form-label">Medicare Number</label>
        <input
          type="text"
          id="medicareNumber"
          name="medicareNumber"
      ...
      <div className="mb-3 col-md-6">
        <label htmlFor="specialDiet" className="form-label">Special Diet</label>
        <input
          type="text"
          id="specialDiet"
          name="specialDiet"
      ...
      <div className="mb-3 col-md-6">
        <label htmlFor="chartingFrom" className="form-label">Charting From</label>
        <input
          type="date"
          id="chartingFrom"
          name="chartingFrom"
      ...
      <div className="mb-3 col-md-6">
        <label htmlFor="chartingTo" className="form-label">Charting To</label>
        <input
          type="date"
          id="chartingTo"
          name="chartingTo"
      ...
      <div className="mb-3 col-md-6">
        <label htmlFor="primaryPhysicianFirstName" className="form-label">First Name</label>
        <input
          type="text"
      ...
      <div className="mb-3 col-md-6">
        <label htmlFor="primaryPhysicianLastName" className="form-label">Last Name</label>
        <input
          type="text"
      ...
      <div className="mb-3 col-md-6">
        <label htmlFor="primaryPhysicianAddress" className="form-label">Address</label>
        <input
          type="text"
      ...
      <div className="mb-3 col-md-6">
        <label htmlFor="primaryPhysicianEmail" className="form-label">Email Address</label>
        <input
          type="email"
      ...
      <div className="mb-3 col-md-6">
        <label htmlFor="primaryPhysicianTelephone" className="form-label">Telephone Number</label>
        <input
          type="text"
      ...
      <div className="mb-3 col-md-6">
        <label htmlFor="houseOrder" className="form-label">House Order</label>
        <input
          type="text"
          id="houseOrder"
          name="houseOrder"
      ...
      <div className="mb-3 col-md-6">
        <label htmlFor="medicationBrandName" className="form-label">Medication Brand Name</label>
        <input
          type="text"
      ...
      <div className="mb-3 col-md-6">
        <label htmlFor="medicationGenericName" className="form-label">Medication Generic Name</label>
        <input
          type="text"
      ...
      <div className="mb-3 col-md-6">
        <label htmlFor="frequencyType" className="form-label">Frequency Type</label>
        <select
          id="frequencyType"
          name="frequencyType"
          className="form-select"
      ...
      <div className="form-check mb-3 col-md-12 ">
        <input
          ...
          onChange={handleChange}
        />
        <label htmlFor="addBowelMovement" className="form-check-label">Add Bowel Movement</label>
      </div>

      <div className="mb-3 col-md-6">
        <label htmlFor="prescribingPhysicianName" className="form-label">Prescribing Physician First & Last Name</label>
        <input
          type="text"
      ...
      <div className="mb-3 col-md-6">
        <label htmlFor="prescribingPhysicianTelephone" className="form-label">Prescribing Physician Telephone Number</label>
        <input
          type="text"
      ...
      <div className="form-check mb-3 col-md-12 ">
        <input
          ...
          onChange={handleChange}
        />
        <label htmlFor="treatmentPrescription" className="form-check-label">Is this prescription a treatment?</label>
      </div>

      <div className="mb-3 col-md-6">
        <label htmlFor="numberOfRefill" className="form-label">Number of Refill</label>
        <input
          type="number"
          id="numberOfRefill"
          name="numberOfRefill"
      ...
      <div className="mb-3 col-md-6">
        <label htmlFor="sideEffects" className="form-label">Side Effects (If any)</label>
        <textarea
          id="sideEffects"
          name="sideEffects"
          className="form-control"
      ...
      <button type="submit" className="btn btn-primary">Save</button>
          ...
          >
            <span className="d-flex align-items-center">
              ...
              <span className="d-none d-sm-inline-block">Active POS</span>
            </span>
          </button>
          <button
          ...
          >
            <span className="d-flex align-items-center">
              ...
              <span className="d-none d-sm-inline-block">InActive POS</span>
            </span>
          </button>
        </div>
        <div className="mt-5">
