...
const Patients = () => {
  ...
  const handleEdit = (rowData) => {
    ...
    setShow(true);
    console.log(rowData.primaryCounty);
                ...
                <form className=" mt-5">
                  <div className="accordion" id="patientInfoAccordion">
                          ...
                          <div className="row mb-3">
                            ...
                            <div className="col-md-6">
                              ...
                              <small className="form-text text-muted">
                                For emergency preparedness, the patient will be
                                contacted at this number. This will also
                                populate to the Emergency Preparedness Report.
                              </small>
                            </div>
                          </div>
                          <div className="row mb-3">
                          ...
                          <div className="row mb-3">
                            ...
                            <div className="col-md-6">
                              ...
                              >
                                ...
                                <option value="caseManager1">
                                  Case Manager 1
                                </option>
                                <option value="caseManager2">
                                  Case Manager 2
                                </option>
                              </select>
                            </div>
                      ...
                      >
                        <div className="accordion-body">
                          ...
                          <div className="mb-3">
                            <p>
                              <strong>
                                (A1010) What is your race? (Check all that
                                apply.)
                              </strong>
                            </p>
                            {raceOptions.map((option) => (
                              <div className="form-check" key={option.id}>
                                <input
                                  ...
                                  checked={
                                    formData.race &&
                                    formData.race.includes(option.value)
                                  }
                                  onChange={(e) =>
                                    handleInputChange(e, option.value)
                                  }
                        ...
                        <div className="accordion-body">
                          ...
                          <div className="mb-3">
                            <label className="form-label">
                              (A1110B) Do you need or want an interpreter to
                          ...
                          {paymentOptions.map((option) => (
                            <div className="form-check" key={option.id}>
                              <input
                                ...
                                onChange={(e) =>
                                  handleInputChange(e, option.label)
                                }
                              />
                              <label
                                className="form-check-label"
                    ...
                    <div className="accordion-item">
                      <h2
                        className="accordion-header"
                        id="admissionSourceTimingHeading"
                      >
                        <button
                          className="accordion-button"
                          type="button"
                        ...
                        <div className="accordion-body">
                          ...
                          <div>
                            <p>
                              ...
                              health episode, for which this assessment will
                              define a case-mix group, an "early" episode or a
                              "later" episode in the patient's current sequence
                              of adjacent Medicare home health payment episodes?
                            </p>{" "}
                            <h5>
                          ...
                          <div className="form-check">
                            <input
                              ...
                              checked={
                                formData.episodeTiming === "Not Applicable"
                              }
                              onChange={handleInputChange}
                            />
                            <label
