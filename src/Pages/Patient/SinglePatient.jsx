                    ...
                    <div className="row invoice-preview ">
                        ...
                        <div className="col-md-6">
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              6. Title programs (for example, Title III, V, or
                              XX)
                            </label>
                          </div>
                          <div className="form-check">
                        ...
                        <div className="col-md-6">
                          ...
                          <div className="form-check">
                            ...
                            >
                              ...
                              or from getting my medications
                            </label>
                          </div>
                          <div className="form-check">
                            <input
                        ...
                        <div className="col-md-6">
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              1. Improper medication administration, adverse
                              drug reactions, medication side effects, toxicity,
                              anaphylaxis
                            </label>
                          </div>
                          <div className="form-check">
                      ...
                      <div className="row ">
                        <div className="col-md-6">
                          <label
                            ...
                            className="form-label mr-2"
                          >
                            M2410. To which Inpatient Facility has the patient
                            been admitted?
                          </label>
                          <div className="form-check">
                            <input
                        ...
                        <div className="col-md-6">
                          ...
                          <div className="form-check">
                            ...
                            >
                              ...
                              skilled services from a Medicare Certified HHA or
                      ...
                      <div className="row ">
                        <div className="col-md-6">
                          <label
                            ...
                            className="form-label mr-2"
                          >
                            A2120. Provision of Current Reconciled Medication
                            List to Subsequent Provider at Transfer
                          </label>
                          <div className="form-check">
                            <input
                              type="radio"
                      ...
                      <div className="row ">
                        <div className="col-md-6">
                          <label
                            ...
                            className="form-label mr-2"
                          >
                            A2123. Provision of Current Reconciled Medication
                            List to Patient at Discharge
                          </label>
                          <div className="form-check">
                            <input
                              type="radio"
                        ...
                        <div className=" col-md-12 w-50">
                          ...
                          <div className="form-check">
                            ...
                            >
                              ...
                              environments (e.g., when person speaks softly, or
                              setting is noisy)
                            </label>
                          </div>
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              Moderate difficulty – speaker has to increase
                        ...
                        <div className=" col-md-12 w-50">
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              Adequate – sees fine detail, such as regular print
                              in newspapers/books
                            </label>
                          </div>
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              Moderately impaired – limited vision; not able to
                              see newspaper headlines but can identify objects
                            </label>
                          </div>
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              Highly impaired – object identification in
                            ...
                            <div className="col-md-4">
                              ...
                              <div className="form-check">
                                <input
                                  ...
                                  value="0"
                                  checked={
                                    formData?.temporalOrientationYear === "0"
                                  }
                                />
                                <label
                                  className="form-check-label"
                              ...
                              <div className="form-check">
                                <input
                                  ...
                                  value="1"
                                  checked={
                                    formData?.temporalOrientationYear === "1"
                                  }
                                />
                                <label
                                  className="form-check-label"
                              ...
                              <div className="form-check">
                                <input
                                  ...
                                  value="2"
                                  checked={
                                    formData?.temporalOrientationYear === "2"
                                  }
                                />
                                <label
                                  className="form-check-label"
                              ...
                              <div className="form-check">
                                <input
                                  ...
                                  value="3"
                                  checked={
                                    formData?.temporalOrientationYear === "3"
                                  }
                                />
                                <label
                                  className="form-check-label"
                            ...
                            <div className="col-md-4">
                              ...
                              <div className="form-check">
                                <input
                                  ...
                                  value="0"
                                  checked={
                                    formData?.temporalOrientationMonth === "0"
                                  }
                                />
                                <label
                                  className="form-check-label"
                              ...
                              <div className="form-check">
                                <input
                                  ...
                                  value="1"
                                  checked={
                                    formData?.temporalOrientationMonth === "1"
                                  }
                                />
                                <label
                                  className="form-check-label"
                              ...
                              <div className="form-check">
                                <input
                                  ...
                                  value="2"
                                  checked={
                                    formData?.temporalOrientationMonth === "2"
                                  }
                                />
                                <label
                                  className="form-check-label"
                            ...
                            <div className="col-md-4">
                              ...
                              <div className="form-check">
                                <input
                                  ...
                                  value="0"
                                  checked={
                                    formData?.temporalOrientationDay === "0"
                                  }
                                />
                                <label
                                  className="form-check-label"
                              ...
                              <div className="form-check">
                                <input
                                  ...
                                  value="1"
                                  checked={
                                    formData?.temporalOrientationDay === "1"
                                  }
                                />
                                <label
                                  className="form-check-label"
                            ...
                            <div className="col-md-6">
                              ...
                              <div className="form-check">
                                <input
                                  ...
                                  value="0"
                                  checked={
                                    formData?.disorganizedThinking === "0"
                                  }
                                />
                                <label
                                  className="form-check-label"
                              ...
                              <div className="form-check">
                                <input
                                  ...
                                  value="1"
                                  checked={
                                    formData?.disorganizedThinking === "1"
                                  }
                                />
                                <label
                                  className="form-check-label"
                            ...
                            <div className="col-md-6">
                              ...
                              <div className="form-check">
                                <input
                                  ...
                                  value="0"
                                  checked={
                                    formData?.alteredConsciousness === "0"
                                  }
                                />
                                <label
                                  className="form-check-label"
                              ...
                              <div className="form-check">
                                <input
                                  ...
                                  value="1"
                                  checked={
                                    formData?.alteredConsciousness === "1"
                                  }
                                />
                                <label
                                  className="form-check-label"
                        ...
                        <div className=" w-50 col-md-6">
                          ...
                          <div className="form-check">
                            ...
                            >
                              ...
                              situations. Is not alert and oriented or is unable
                              to shift attention and recall directions more than
                              half the time.
                            </label>
                          </div>
                          <div className="form-check">
                            ...
                            >
                              ...
                              constant disorientation, coma, persistent
                      ...
                      <div className=" w-50 col-md-6">
                        <label
                          ...
                          className="form-label mr-2"
                        >
                          D0150. Is the patient rarely/never understood
                          verbally, in writing, or using another method?
                        </label>
                      ...
                      <div className=" w-50 col-md-6">
                        <label
                          ...
                          className="form-label mr-2"
                        >
                          D0700. Social Isolation: How often do you feel lonely
                          or isolated from those around you?
                        </label>
                      ...
                      <div className=" w-50 col-md-6">
                        ...
                        >
                          ...
                          that are demonstrated at least once a week (Reported
                          or Observed):
                        </label>
                        <div className="form-check">
                          <input
                          ...
                          >
                            ...
                            persons/places, inability to recall events of past
                            24 hours, significant memory loss so that
                        ...
                        <div className="form-check">
                          ...
                          >
                            4. Physical aggression: aggressive or combative to
                            self and others (for example, hits self, throws
                            objects, punches, dangerous maneuvers with
                      ...
                      <div className="row">
                          ...
                          <div className="mb-4">
                            ...
                            <div className="form-check mb-2">
                              <input
                                ...
                                value="A01"
                                checked={formData?.livingArrangement?.includes(
                                  "A01"
                                )}
                              />
                              <label
                            ...
                            <div className="form-check mb-2">
                              ...
                              <label
                                ...
                                className="form-check-label"
                              >
                                Patient lives alone, Occasional/Short-Term
                                Assistance
                              </label>
                            </div>
                            <div className="form-check mb-2">
                            ...
                            <div className="form-check mb-2">
                              ...
                              <label
                                ...
                                className="form-check-label"
                              >
                                Patient lives with other person(s), Around the
                                clock
                              </label>
                            </div>
                            <div className="form-check mb-2">
                              ...
                              <label
                                ...
                                className="form-check-label"
                              >
                                Patient lives with other person(s), Regular
                                Daytime
                              </label>
                            </div>
                            <div className="form-check mb-2">
                            ...
                            <div className="form-check mb-2">
                              ...
                              <label
                                ...
                                className="form-check-label"
                              >
                                Patient lives with other person(s), No
                            ...
                            <div className="form-check mb-2">
                              ...
                              <label
                                ...
                                className="form-check-label"
                              >
                                Patient lives in congregate situation, Around
                                the clock
                              </label>
                            </div>
                            <div className="form-check mb-2">
                            ...
                            <div className="form-check mb-2">
                              ...
                              <label
                                ...
                                className="form-check-label"
                              >
                                Patient lives in congregate situation, No
                                Assistance Available
                              </label>
                            </div>
                          </div>
                        ...
                        <div className=" w-50 col-md-6">
                          ...
                          <div className="form-check mb-2">
                            <input
                              ...
                              value="0"
                              checked={
                                formData?.medicalProceduresAssistance === "0"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                          ...
                          <div className="form-check mb-2">
                            <input
                              ...
                              value="1"
                              checked={
                                formData?.medicalProceduresAssistance === "1"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                          ...
                          <div className="form-check mb-2">
                            <input
                              ...
                              value="2"
                              checked={
                                formData?.medicalProceduresAssistance === "2"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                          ...
                          <div className="form-check mb-2">
                            <input
                              ...
                              value="3"
                              checked={
                                formData?.medicalProceduresAssistance === "3"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                          ...
                          <div className="form-check mb-2">
                            <input
                              ...
                              value="4"
                              checked={
                                formData?.medicalProceduresAssistance === "4"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                        ...
                        <div className=" w-50 col-md-6">
                          <label
                            ...
                            className="form-label mr-2"
                          >
                            f. Supervision and safety (due to cognitive
                            impairment)
                          </label>
                          <div className="form-check mb-2">
                            <input
                              ...
                              value="0"
                              checked={
                                formData?.supervisionSafetyAssistance === "0"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                          ...
                          <div className="form-check mb-2">
                            <input
                              ...
                              value="1"
                              checked={
                                formData?.supervisionSafetyAssistance === "1"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                          ...
                          <div className="form-check mb-2">
                            <input
                              ...
                              value="2"
                              checked={
                                formData?.supervisionSafetyAssistance === "2"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                          ...
                          <div className="form-check mb-2">
                            <input
                              ...
                              value="3"
                              checked={
                                formData?.supervisionSafetyAssistance === "3"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                          ...
                          <div className="form-check mb-2">
                            <input
                              ...
                              value="4"
                              checked={
                                formData?.supervisionSafetyAssistance === "4"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                      ...
                      <div className="row">
                        ...
                        <div className=" w-50 col-md-6">
                          ...
                          <div className="form-check">
                            ...
                            />
                            Unable to use shower/tub, but can bathe at sink or
                            chair
                          </div>
                          <div className="form-check">
                            {" "}
                            ...
                            />
                            Unable to use shower/tub, but can bathe in bed or
                            with assistance
                          </div>
                          <div className="form-check">
                            {" "}
                        ...
                        <div className=" w-50 col-md-6">
                          ...
                          <div className="form-check">
                            ...
                            />
                            Able to manage toileting hygiene if supplies are
                            laid out
                          </div>
                          <div className="form-check">
                            {" "}
                              ...
                              <div>
                                <div className="form-check">
                                  <input
                                    ...
                                    value="3"
                                    checked={
                                      formData?.gg0100?.indoorMobility === "3"
                                    }
                                    className="form-check-input"
                                  />
                                  <label
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="2"
                                    checked={
                                      formData?.gg0100?.indoorMobility === "2"
                                    }
                                    className="form-check-input"
                                  />
                                  <label
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="1"
                                    checked={
                                      formData?.gg0100?.indoorMobility === "1"
                                    }
                                    className="form-check-input"
                                  />
                                  <label
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="8"
                                    checked={
                                      formData?.gg0100?.indoorMobility === "8"
                                    }
                                    className="form-check-input"
                                  />
                                  <label
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="9"
                                    checked={
                                      formData?.gg0100?.indoorMobility === "9"
                                    }
                                    className="form-check-input"
                                  />
                                  <label
                              ...
                              <div>
                                <div className="form-check">
                                  <input
                                    ...
                                    value="3"
                                    checked={
                                      formData?.gg0100?.functionalCognition ===
                                      "3"
                                    }
                                    className="form-check-input"
                                  />
                          ...
                          <div>
                            ...
                            <div className="form-check">
                              <input
                                ...
                                checked={
                                  formData?.gg0110?.manualWheelchair || false
                                }
                                disabled
                              />
                              <label
                            ...
                            <div className="form-check">
                              <input
                                ...
                                checked={
                                  formData?.gg0110?.mechanicalLift || false
                                }
                                disabled
                              />
                              <label
                            ...
                            <div className="form-check">
                              <input
                                ...
                                checked={
                                  formData?.gg0110?.orthoticsProsthetics ||
                                  false
                                }
                                disabled
                              />
                            ...
                            <div className="form-check">
                              <input
                                ...
                                checked={
                                  formData?.gg0110?.noneOfTheAbove || false
                                }
                                disabled
                              />
                              <label
                              ...
                              <div>
                                <div className="form-check">
                                  <input
                                    ...
                                    value="06"
                                    checked={
                                      formData?.gg0170?.rollLeftRight === "06"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="05"
                                    checked={
                                      formData?.gg0170?.rollLeftRight === "05"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="04"
                                    checked={
                                      formData?.gg0170?.rollLeftRight === "04"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="03"
                                    checked={
                                      formData?.gg0170?.rollLeftRight === "03"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="02"
                                    checked={
                                      formData?.gg0170?.rollLeftRight === "02"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="01"
                                    checked={
                                      formData?.gg0170?.rollLeftRight === "01"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="07"
                                    checked={
                                      formData?.gg0170?.rollLeftRight === "07"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="09"
                                    checked={
                                      formData?.gg0170?.rollLeftRight === "09"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="10"
                                    checked={
                                      formData?.gg0170?.rollLeftRight === "10"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="88"
                                    checked={
                                      formData?.gg0170?.rollLeftRight === "88"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                              ...
                              <div>
                                <div className="form-check">
                                  <input
                                    ...
                                    value="06"
                                    checked={
                                      formData?.gg0170?.lyingToSitting === "06"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="05"
                                    checked={
                                      formData?.gg0170?.lyingToSitting === "05"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="04"
                                    checked={
                                      formData?.gg0170?.lyingToSitting === "04"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="03"
                                    checked={
                                      formData?.gg0170?.lyingToSitting === "03"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="02"
                                    checked={
                                      formData?.gg0170?.lyingToSitting === "02"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="01"
                                    checked={
                                      formData?.gg0170?.lyingToSitting === "01"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="07"
                                    checked={
                                      formData?.gg0170?.lyingToSitting === "07"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="09"
                                    checked={
                                      formData?.gg0170?.lyingToSitting === "09"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="10"
                                    checked={
                                      formData?.gg0170?.lyingToSitting === "10"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                                ...
                                <div className="form-check">
                                  <input
                                    ...
                                    value="88"
                                    checked={
                                      formData?.gg0170?.lyingToSitting === "88"
                                    }
                                  />
                                  <label
                                    className="form-check-label"
                      ...
                      <div className="row">
                        <div className=" w-50 col-md-6">
                          <label
                            ...
                            className="form-label mr-2"
                          >
                            M1600. Has this patient been treated for a Urinary
                        ...
                        <div className=" w-50 col-md-6">
                          <label
                            ...
                            className="form-label mr-2"
                          >
                            M1610. Urinary Incontinence or Urinary Catheter
                            Presence
                          </label>
                          <div className="form-check">
                            <input
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              No incontinence or catheter (includes anuria or
                        ...
                        <div className=" w-50 col-md-6">
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              Patient does not have an ostomy for bowel
                              elimination
                            </label>
                          </div>
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              Patient’s ostomy was not related to an inpatient
                      ...
                      <div className="row">
                                  ...
                                  {[0, 1, 2, 3, 4]?.map((rating) => (
                                    <div className="form-check " key={rating}>
                                      <input
                                        ...
                                        value={rating}
                                        checked={
                                          formData?.otherDiagnosesRatings[
                                            index
                                          ] === rating.toString()
                                        }
                                        onChange={() =>
                        ...
                        <div className=" w-50 col-md-6">
                          <label
                            ...
                            className="form-label mr-2"
                          >
                            M1028. Active Diagnoses – Comorbidities and
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              Peripheral Vascular Disease (PVD) or Peripheral
                              Artery Disease (PAD)
                            </label>
                          </div>
                          <div className="form-check">
                          ...
                          <div className="form-check">
                            <input
                              ...
                              type="checkbox"
                              value="none"
                              checked={formData?.comorbidities?.includes(
                                "none"
                              )}
                              className="form-check-input"
                            />
                        ...
                        <div className=" w-50 col-md-6">
                          ...
                          <div className="form-check">
                            ...
                            >
                              ...
                              with an injury — in the past 12 months)
                            </label>
                          </div>
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              Unintentional weight loss of a total of 10 pounds
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              Multiple hospitalizations (2 or more) in the past
                              6 months
                            </label>
                          </div>
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              Multiple emergency department visits (2 or more)
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              Reported or observed history of difficulty
                              complying with any medical instructions in the
                              past 3 months
                            </label>
                          </div>
                          ...
                          {[
                            ...
                            <div key={value} className="form-check">
                              <input
                                ...
                                value={value}
                                checked={
                                  formData?.painInterferenceWithTherapy ===
                                  value
                                }
                                className="form-check-input"
                              />
                          ...
                          {[
                            ...
                            <div key={value} className="form-check">
                              <input
                                ...
                                value={value}
                                checked={
                                  formData?.painInterferenceWithActivities ===
                                  value
                                }
                                className="form-check-input"
                              />
                            ...
                            <div className=" w-50 col-md-6">
                              ...
                              <div className="form-check">
                                ...
                                <label
                                  ...
                                  className="form-check-label"
                                >
                                  Therapeutic diet (e.g., low salt, diabetic,
                                  low cholesterol)
                                </label>
                              </div>
                      ...
                      <div className="row">
                        ...
                        <div className=" w-50 col-md-6">
                          <h6 style={{ fontSize: "12px" }}>
                            M1307. The Oldest Stage 2 Pressure Ulcer that is
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              NA. No Stage 2 pressure ulcers are present at
                              discharge
                            </label>
                          </div>
                        </div>
                        ...
                        <div className=" w-50 col-md-6">
                          ...
                          <div className="form-group">
                            <label>
                              Number of these unstageable pressure
                              ulcers/injuries that were present at most recent
                              SOC/ROC:
                            </label>
                        ...
                        <div className=" w-50 col-md-6">
                          ...
                          <p>
                            Known but not stageable due to coverage of wound bed
                        ...
                        <div className=" w-50 col-md-6">
                          ...
                          <p>
                            Number of unstageable pressure injuries presenting
                          ...
                          <div className="form-group">
                            <label>
                              Number of these unstageable pressure injuries that
                        ...
                        <div className=" w-50 col-md-6">
                          ...
                          <p>
                            ...
                            Darkly pigmented skin may not have a visible
                            blanching; in dark skin tones only, it may appear
                            with persistent blue or purple hues.
                          </p>
                          <div className="form-check">
                            <input
                              type="radio"
                        ...
                        <div className=" w-50 col-md-6">
                          ...
                          <p>
                            Excludes pressure ulcer/injury that cannot be staged
                            due to a non-removable dressing/device, coverage of
                            wound bed by slough and/or eschar, or deep tissue
                            injury.
                          </p>
                          <div className="form-check">
                            <input
                        ...
                        <div className="mb-3 w-50 col-md-6">
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              1. Yes, patient has BOTH observable and
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              3. Yes, patient has unobservable stasis ulcers
                        ...
                        <div className="mb-3 w-50 col-md-6">
                          <h6 style={{ fontSize: "12px" }}>
                            M1334. Status of Most Problematic Stasis Ulcer that
                            is Observable
                          </h6>
                          <div className="form-check">
                            <input
                          ...
                          <div className="form-check">
                            ...
                            <div className="form-check form-check-inline">
                              <input
                                ...
                                type="checkbox"
                                checked={
                                  formData?.highRiskDrugs?.antibiotic
                                    ?.indicationNoted
                                }
                              />
                              <label
                          ...
                          <div className="form-check">
                            ...
                            <div className="form-check form-check-inline">
                              <input
                                ...
                                type="checkbox"
                                checked={
                                  formData?.highRiskDrugs?.opioid?.isTaking
                                }
                              />
                              <label
                                style={{ fontSize: "12px" }}
                          ...
                          <div className="form-check">
                            ...
                            <div className="form-check form-check-inline">
                              <input
                                ...
                                type="checkbox"
                                checked={
                                  formData?.highRiskDrugs?.none?.isTaking
                                }
                              />
                              <label
                                style={{ fontSize: "12px" }}
                        ...
                        <div className="mb-3 w-50 col-md-6">
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              NA — No potential issues identified or patient is
                        ...
                        <div className="mb-3 w-50 col-md-6">
                          ...
                          <div className="form-check">
                            <input
                              ...
                              value="0"
                              checked={
                                formData?.managementOralMedications === "0"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                              className="form-check-label"
                            >
                              Able to independently take the correct
                              medication(s)
                            </label>
                          </div>
                          <div className="form-check">
                            <input
                              ...
                              value="1"
                              checked={
                                formData?.managementOralMedications === "1"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                              className="form-check-label"
                            >
                              Able to take medication(s) if prepared in advance
                              or if using a drug diary/chart
                            </label>
                          </div>
                          <div className="form-check">
                            <input
                              ...
                              value="2"
                              checked={
                                formData?.managementOralMedications === "2"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                          ...
                          <div className="form-check">
                            <input
                              ...
                              value="3"
                              checked={
                                formData?.managementOralMedications === "3"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                              className="form-check-label"
                            >
                              Unable to take medication unless administered by
                              another person
                            </label>
                          </div>
                          <div className="form-check">
                            <input
                              ...
                              value="NA"
                              checked={
                                formData?.managementOralMedications === "NA"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                        ...
                        <div className="mb-3 w-50 col-md-6">
                          ...
                          <div className="form-check">
                            <input
                              ...
                              value="0"
                              checked={
                                formData?.managementInjectableMedications ===
                                "0"
                              }
                            />
                            <label
                          ...
                          <div className="form-check">
                            ...
                            <label
                              ...
                              className="form-check-label"
                            >
                              Able to take medication(s) if syringes are
                              prepared in advance or if using a drug diary/chart
                            </label>
                          </div>
                          <div className="form-check">
                            <input
                        ...
                        <div className="mb-3 w-50 col-md-6">
                          ...
                          <div className="form-check">
                            <input
                              ...
                              value="0"
                              checked={
                                formData?.covidVaccinationUpToDate === "0"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                          ...
                          <div className="form-check">
                            <input
                              ...
                              value="1"
                              checked={
                                formData?.covidVaccinationUpToDate === "1"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                          ...
                          <div className="mb-3 w-50 col-md-6">
                            ...
                            <div className="form-check">
                              <input
                                ...
                                value="1"
                                checked={
                                  formData?.influenzaVaccineReceived === "1"
                                }
                              />
                              <label
                                style={{ fontSize: "12px" }}
                            ...
                            <div className="form-check">
                              <input
                                ...
                                value="2"
                                checked={
                                  formData?.influenzaVaccineReceived === "2"
                                }
                              />
                              <label
                                style={{ fontSize: "12px" }}
                            ...
                            <div className="form-check">
                              <input
                                ...
                                value="3"
                                checked={
                                  formData?.influenzaVaccineReceived === "3"
                                }
                              />
                              <label
                                style={{ fontSize: "12px" }}
                            ...
                            <div className="form-check">
                              <input
                                ...
                                value="4"
                                checked={
                                  formData?.influenzaVaccineReceived === "4"
                                }
                              />
                              <label
                                style={{ fontSize: "12px" }}
                            ...
                            <div className="form-check">
                              <input
                                ...
                                value="5"
                                checked={
                                  formData?.influenzaVaccineReceived === "5"
                                }
                              />
                              <label
                                style={{ fontSize: "12px" }}
                                className="form-check-label"
                              >
                                No; patient assessed and determined to have
                            ...
                            <div className="form-check">
                              <input
                                ...
                                value="6"
                                checked={
                                  formData?.influenzaVaccineReceived === "6"
                                }
                              />
                              <label
                                style={{ fontSize: "12px" }}
                            ...
                            <div className="form-check">
                              <input
                                ...
                                value="7"
                                checked={
                                  formData?.influenzaVaccineReceived === "7"
                                }
                              />
                              <label
                                style={{ fontSize: "12px" }}
                            ...
                            <div className="form-check">
                              <input
                                ...
                                value="8"
                                checked={
                                  formData?.influenzaVaccineReceived === "8"
                                }
                              />
                              <label
                                style={{ fontSize: "12px" }}
                                className="form-check-label"
                              >
                                No; patient did not receive the vaccine due to
                                other reasons
                              </label>
                            </div>
                          </div>
                        ...
                        <div className="mb-3 w-50 col-md-6">
                          ...
                          <div className="form-check">
                            <input
                              ...
                              value="NA"
                              checked={
                                formData?.depressionIntervention === "NA"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                        ...
                        <div className="mb-3 w-50 col-md-6">
                          ...
                          <div className="form-check">
                            <input
                              ...
                              value="0"
                              checked={
                                formData?.pressureUlcerPrevention === "0"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                          ...
                          <div className="form-check">
                            <input
                              ...
                              value="1"
                              checked={
                                formData?.pressureUlcerPrevention === "1"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                          ...
                          <div className="form-check">
                            <input
                              ...
                              value="NA"
                              checked={
                                formData?.pressureUlcerPrevention === "NA"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                        ...
                        <div className="mb-3 w-50 col-md-6">
                          ...
                          <div className="form-check">
                            <input
                              ...
                              value="NA"
                              checked={
                                formData?.pressureUlcerTreatment === "NA"
                              }
                            />
                            <label
                              style={{ fontSize: "12px" }}
                      ...
                      <div className="col-xl-12 col-md-12 col-12 mb-md-0 ">
                        ...
                        <div className="mb-1">
                          ...
                          <div className="row g-3">
                            {formPayerData?.occurrenceCodes?.map(
                              (code, index) => (
                                <React.Fragment key={`occurrenceCode-${index}`}>
                                  <div className="col-md-6 w-50">
                                    <label
                                      ...
                                      className="form-label d-block"
                                    >
                                      {`${31 + Math.floor(index / 2)}A`}{" "}
                                      Occurrence Code
                                    </label>
                                    {formPayerData?.occurrenceCodes[index]
                                      ?.code || "N/A"}
                                  </div>
                                  <div className="col-md-6 w-50">
                                    <label
                        ...
                        <div className="mb-1">
                          ...
                          <div className="row g-3">
                            {formPayerData?.occurrenceSpans?.map(
                              (span, index) => (
                        ...
                        <div className="mb-1">
                          ...
                          <div className="row g-3">
                            {formPayerData?.conditionCodes?.map(
                              (code, index) => (
                                <div
                                ...
                                >
                                  ...
                                  {formPayerData?.conditionCodes[index] ||
                                    "N/A"}
                                </div>
                              )
                            )}
                        ...
                        <div className="mb-1">
                          ...
                          <div className="row g-3">
                            ...
                            <div className="col-md-6 w-50">
                              ...
                              {formPayerData?.emergencyTreatmentIndicator ||
                                "N/A"}
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="col-xl-12 col-md-12 col-12 mb-md-0 ">
                        ...
                        <div className="row">
                          ...
                          <div className=" col-md-6 w-50">
                            ...
                            {formPhysicianData?.medicaidProviderIdentifier ||
                              "N/A"}
                          </div>
                        </div>
                            ...
                            {[
                              ...
                              <div className="form-check" key={dme}>
                                <input
                                  ...
                                  name="dmeNeeded"
                                  value={dme}
                                  checked={formClinicalData?.dmeNeeded?.includes(
                                    dme
                                  )}
                                  className="form-check-input"
                                />
                      ...
                      <div className="col-xl-12 col-md-12 col-12 mb-md-0 ">
                        <div className="row g-3">
                          ...
                          <div className="row">
                            ...
                            <div className="col-md-6 w-50">
                              ...
                              {formContactData?.primary?.alternatePhone ||
                                "N/A"}
                            </div>
                          </div>
                        ...
                        <div className="row">
                          {!formContactData?.primary?.sameAsPatientAddress && (
                            <React.Fragment>
                              <div className="col-md-6">
                                ...
                                {formContactData?.primary?.addressLine1 ||
                                  "N/A"}
                              </div>
                              <div className="col-md-6">
                                <label
                                ...
                                {formContactData?.primary?.addressLine2 ||
                                  "N/A"}
                              </div>
                              <div className="col-md-6">
                                <label
                          ...
                          {formContactData?.additional?.map(
                            (contact, index) => (
                            ...
                            {formContactData?.representativeContacted ===
                              ...
                              <>
                                <div className="form-check">
                                  ...
                                  >
                                    Contacted and will be available for
                                    admission visit to receive written notice in
                                    advance of care
                                  </label>
                                </div>
                                <div className="form-check">
                                  ...
                                  >
                                    ...
                                    available for admission visit (if this
                                    person has healthcare decision making
                                    authority, the HHA must provide notice of
                                    the patient &apos;s rights prior to
                                    initiating care. May obtain electronic or
                                    digital signature)
                                  </label>
                                </div>
                                <div className="form-check">
                        ...
                        <div className="row">
                          <div className=" col-md-6 w-50">
                            ...
                            <div>
                              <input
                                ...
                                value="1"
                                checked={
                                  formEmergencyData?.emergencyTriage === "1"
                                }
                              />{" "}
                              ...
                              <input
                                ...
                                value="2"
                                checked={
                                  formEmergencyData?.emergencyTriage === "2"
                                }
                              />{" "}
                              ...
                              <input
                                ...
                                value="3"
                                checked={
                                  formEmergencyData?.emergencyTriage === "3"
                                }
                              />{" "}
                              ...
                              <input
                                ...
                                value="4"
                                checked={
                                  formEmergencyData?.emergencyTriage === "4"
                                }
                              />{" "}
                          ...
                          <div className=" col-md-6 w-50">
                            ...
                            <div>
                              ...
                              />{" "}
                              Contact made with local/state emergency
                              preparedness officials regarding patient in need
                              of help during an evacuation
                            </div>
                            <div>
                              <input
                                type="checkbox"
                            ...
                            {formEmergencyData?.additionalInfo
                              ?.medicalNeeds && (
                              <div>
                                <label
                                  style={{ fontSize: "11px" }}
                        ...
                        <div className="row ">
                          ...
                          <div className="col-md-6 my-2">
                            <input
                              ...
                              checked={formEmergencyData?.evacuationAddress}
                            />{" "}
