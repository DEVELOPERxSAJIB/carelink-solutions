...
const CaregiverOrStaff = () => {
  ...
  const [deleteRoleBasedUser, {data : deletedUser, isSuccess: isDeleteSuccess}] = useDeleteRoleBasedUserMutation()

  const {
    data: roleBasedUserData,
    isLoading : roleBasedUserLoader,
    refetch
  } = useRoleBasedUserQuery("caregiver");
  ...
  return (
    <>
      {roleBasedUserLoader && <MainLoader />}
      <div className="card">
        <TableHeader
