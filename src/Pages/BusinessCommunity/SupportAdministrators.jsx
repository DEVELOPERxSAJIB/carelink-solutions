...
const SupportAdministrators = () => {
  ...
  const { data, refetch } = useGetAllSupportAdministratorQuery();
  const [
  ...
  const onSubmit = (data) => {
    const updatedData = {
      ...
      state: selectedState,
      supportadministratorID: generateRandomId("supportadministrator"),
                        ...
                        <div className="row mx-5">
                          <div className="mb-3 col-md-12">
                            <select
                              ...
                              {...register("role")}
                              value="supportadministrator"
                              disabled
                            >
                              <option value="supportadministrator">
