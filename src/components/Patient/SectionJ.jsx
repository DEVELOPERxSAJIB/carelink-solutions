...
const dispatch = useDispatch()
  ...
  const handleInputChange = (e) => {
    ...
    } else if (name.startsWith('fallsDetails')) {
      setFormData((prevData) => ({
        ...prevData,
        fallsDetails: {
        ...
        <div className="accordion-item">
          ...
          >
            <div ref={componentRef} className="accordion-body print-area">
              ...
              <div className="mb-3">
                <label className="form-label">M1033. Risk for Hospitalization</label>
                {[
                  { label: 'History of falls (2 or more falls — or any fall with an injury — in the past 12 months)', value: 'falls' },
                  { label: 'Unintentional weight loss of a total of 10 pounds or more in the last 12 months', value: 'weightLoss' },
                  { label: 'Multiple hospitalizations (2 or more) in the past 6 months', value: 'hospitalizations' },
                  { label: 'Multiple emergency department visits (2 or more) in the past 6 months', value: 'emergencyVisits' },
                  { label: 'Decline in mental, emotional, or behavioral status in the past 3 months', value: 'declineInStatus' },
                  { label: 'Reported or observed history of difficulty complying with any medical instructions in the past 3 months', value: 'complianceDifficulty' },
                  { label: 'Currently taking 5 or more medications', value: 'medications' },
                  { label: 'Currently reports exhaustion', value: 'exhaustion' },
                  { label: 'Other risk(s) not listed in 1-8', value: 'otherRisks' },
              ...
              <div className="mb-3">
                <label htmlFor="painEffectOnSleep" className="form-label">J0510. Pain Effect on Sleep</label>
                <select
                ...
                >
                  ...
                  <option value="0">Does not apply — I have not had any pain or hurting in the past 5 days</option>
              ...
              <div className="mb-3">
                <label htmlFor="painInterferenceWithTherapy" className="form-label">J0520. Pain Interference with Therapy Activities</label>
                <select
                ...
                >
                  <option value="">Select...</option>
                  <option value="0">Does not apply — I have not received rehabilitation therapy in the past 5 days</option>
                  <option value="1">Rarely or not at all</option>
                  <option value="2">Occasionally</option>
                  <option value="3">Frequently</option>
                  <option value="4">Almost constantly</option>
              ...
              <div className="mb-3">
                <label htmlFor="painInterferenceWithActivities" className="form-label">J0530. Pain Interference with Day-to-Day Activities</label>
                <select
              ...
              <div className="mb-3">
                <label htmlFor="fallsSinceSOCROC" className="form-label">J1800. Any Falls Since SOC/ROC</label>
                <select
                  id="fallsSinceSOCROC"
              ...
              {formData.fallsSinceSOCROC === '1' && (
                <div className="mb-3">
                  <label htmlFor="fallsDetails" className="form-label">J1900. Number of Falls Since SOC/ROC</label>
                  <select
                    id="fallsDetails"
                    name="fallsDetails"
                    className="form-select"
              ...
              <div className="mb-3">
                <label htmlFor="shortOfBreath" className="form-label">M1400. When is the patient dyspneic or noticeably Short of Breath?</label>
                <select
                  id="shortOfBreath"
                  name="shortOfBreath"
                  className="form-select"
