...
const EditReferralInformation = ({ patientId }) => {
  ...
  useEffect(() => {
    setEditId(singleReferral?.payload?.referral?._id);

    setDate(singleReferral?.payload?.referral?.faceToFaceEvaluation);
    setFormData({ ...singleReferral?.payload?.referral });
    setState(singleReferral?.payload?.referral?.state);
    setCity(singleReferral?.payload?.referral?.city);
...
export default EditReferralInformation;
