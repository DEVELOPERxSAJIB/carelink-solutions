...
const EditEmergencyPreparedness = ({ patientId }) => {
  ...
  useEffect(() => {
    setEditId(singleEmergency?.payload?.emergency?._id);
    setFormData({ ...singleEmergency?.payload?.emergency });
    setCity(singleEmergency?.payload?.emergency?.city);
    setState(singleEmergency?.payload?.emergency?.state);
    setCounty(singleEmergency?.payload?.emergency?.county);
...
export default EditEmergencyPreparedness;
