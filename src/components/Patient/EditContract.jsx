...
const EditContract = ({ patientId }) => {
  ...
  useEffect(() => {
    setEditId(singleContact?.payload?.contact?._id);
    setFormData({
      representativeContacted:
        singleContact?.payload?.contact?.representativeContacted || "",
      legalRepresentativeOption:
        singleContact?.payload?.contact?.legalRepresentativeOption || "",
      patientSelectedRepresentativeOption:
        singleContact?.payload?.contact?.patientSelectedRepresentativeOption ||
        "",
      otherDetails: singleContact?.payload?.contact?.otherDetails || "",
      physicianNotified:
        singleContact?.payload?.contact?.physicianNotified || false,
      patientNotified:
        singleContact?.payload?.contact?.patientNotified || false,
      previousField1: singleContact?.payload?.contact?.previousField1 || "",
      previousField2: singleContact?.payload?.contact?.previousField2 || "",
      doNotContactCAHPS:
        singleContact?.payload?.contact?.doNotContactCAHPS || false,
      reasonForNoContact:
        singleContact?.payload?.contact?.reasonForNoContact || "",
      otherReason: singleContact?.payload?.contact?.otherReason || "",
      alternateCAHPSContact:
        singleContact?.payload?.contact?.alternateCAHPSContact || false,
      alternateCAHPSContactDetails: {
        sameAsPrimaryEmergencyContact:
          singleContact?.payload?.contact?.alternateCAHPSContactDetails
            ?.sameAsPrimaryEmergencyContact || false,
        firstName:
          singleContact?.payload?.contact?.alternateCAHPSContactDetails
            ?.firstName || "",
        ...
        addressLine2:
          singleContact?.payload?.contact?.alternateCAHPSContactDetails
            ?.addressLine2 || "",
        city:
          singleContact?.payload?.contact?.alternateCAHPSContactDetails?.city ||
          "",
        state:
          singleContact?.payload?.contact?.alternateCAHPSContactDetails
            ?.state || "",
        zip:
          singleContact?.payload?.contact?.alternateCAHPSContactDetails?.zip ||
          "",
        county:
          singleContact?.payload?.contact?.alternateCAHPSContactDetails
            ?.county || "",
    ...
    setEmergencyContacts({
      primary: {
        firstName:
          singleContact?.payload?.contact?.emergencyContacts?.primary
            ?.firstName || "",
        lastName:
          singleContact?.payload?.contact?.emergencyContacts?.primary
            ?.lastName || "",
        ...
        relationship:
          singleContact?.payload?.contact?.emergencyContacts?.primary
            ?.relationship || "",
        email:
          singleContact?.payload?.contact?.emergencyContacts?.primary?.email ||
          "",
        representative:
          singleContact?.payload?.contact?.emergencyContacts?.primary
            ?.representative || "Legal Representative",
        ...
        addressLine2:
          singleContact?.payload?.contact?.emergencyContacts?.primary
            ?.addressLine2 || "",
        city:
          singleContact?.payload?.contact?.emergencyContacts?.primary?.city ||
          "",
        state:
          singleContact?.payload?.contact?.emergencyContacts?.primary?.state ||
          "",
        zip:
          singleContact?.payload?.contact?.emergencyContacts?.primary?.zip ||
          "",
      },
      additional:
        singleContact?.payload?.contact?.emergencyContacts?.additional?.map(
          (contact) => ({
    ...
    setAdditionalCity(
      singleContact?.payload?.contact?.emergencyContacts?.additional?.[0]
        ?.city || ""
    );
    setAdditionalState(
      singleContact?.payload?.contact?.emergencyContacts?.additional?.[0]
    ...
    setCAHPSState(
      singleContact?.payload?.contact?.alternateCAHPSContactDetails?.state || ""
    );
    setCAHPSCounty(
      singleContact?.payload?.contact?.alternateCAHPSContactDetails?.county ||
        ""
    );
    setSelectedTemplate(
      singleContact?.payload?.contact?.selectedTemplate || ""
    );
    setComments(singleContact?.payload?.contact?.comments || "");
                    ...
                    <>
                      ...
                      <div className="form-check">
                        ...
                        >
                          ...
                          admission visit (if this person has healthcare
                          decision making authority, the HHA must provide notice
                          of the patient &apos;s rights prior to initiating
                          care. May obtain electronic or digital signature)
                        </label>
                      </div>
                      <div className="form-check">
                        <input
