...
const MultiCountySelect = ({ selectedState, selectedCounty, setSelectedCounty }) => {
    ...
    return (
      <Select
        ...
        value={selectedCounty.map(county => ({ value: county, label: county }))}
      />
    );
  };
  
  export default MultiCountySelect;