  ...
  >
    ...
    <ul className="navbar-nav flex-row align-items-center ms-auto">
      ...
      <li className="nav-item dropdown-shortcuts navbar-dropdown dropdown">
        <a
          className={`nav-link btn btn-text-secondary btn-icon rounded-pill btn-icon dropdown-toggle hide-arrow ${isAppDropdownOpen?"show":""}`}
          href="#"
        ...
        <div className={`dropdown-menu dropdown-menu-end p-0 ${isAppDropdownOpen?"show":""}`}>
      ...
      <li className="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-2">
        <a
          className={`nav-link btn btn-text-secondary btn-icon rounded-pill dropdown-toggle hide-arrow ${isNotificationDropdownOpen?"show":""}`}
        ...
        <ul className={`dropdown-menu dropdown-menu-end p-0 ${isNotificationDropdownOpen?"show":""}`}>
      ...
      <li className="nav-item navbar-dropdown dropdown-user dropdown">
        ...
        onClick={toggleDropdown}
          className={`nav-link dropdown-toggle hide-arrow p-0 ${isDropdownOpen?"show":""}`}
          href="#"
          data-bs-toggle="dropdown"
        >
